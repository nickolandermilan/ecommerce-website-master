...
<head>
    ...
    <title> Shofee | Online Shopping Site for Men</title>
...
<div class="container" style="margin-top:65px">
    ...
    <div class="row text-center" id="watch">
        <div class="col-md-3 col-6 py-2">
            <div class="card">
            <a class="text-dark" href="1.php"> <img src="images/watch1.jpg" alt="" class="img-fluid pb-1" >
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
            <a class="text-dark" href="2.php"><img src="images/watch2.jpg" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Guest Watch</h6></a>
                    <h6>Price :₱ 2500</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
            <a class="text-dark" href="3.php"> <img src="images/watch3.jpg" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Panerai Watch</h6></a>
                    <h6>Price :₱ 3500</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
            <a class="text-dark" href="4.php"><img src="images/watch4.jpg" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Nonos Watch</h6></a>
                    <h6>Price :₱ 1800</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
    ...
    <div class="row text-center" id="shirt">
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                <a class="text-dark" href="5.php"><img src="images/shirt1.jpg" alt="" class="img-fluid pb-1"  >
                    <div class="figure-caption">
                    <h6>Levis</h6></a>
                    <h6>Price :₱ 1800</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                <a class="text-dark" href="6.php"> <img src="images/shirt2.jpg" alt="" class="img-fluid pb-1" >
                    <div class="figure-caption">
                    <h6>Louis Philippe t-shirt</h6></a>
                    <h6>Price :₱ 2500</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                <a class="text-dark" href="7.php"> <img src="images/shirt3.jpg" alt="" class="img-fluid pb-1">
                    <div class="figure-caption">
                        <h6>Highlander t-shirt</h6></a>
                        <h6>Price :₱ 500</h6>
                        <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
            ...
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                <a class="text-dark" href="8.php"> <img src="images/shirt4.jpg" alt="" class="img-fluid pb-1">
                    <div class="figure-caption">
                        <h6>GUCCI White t-Shirt</h6></a>
                        <h6>Price :₱ 2300</h6>
                        <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
        ...
        <div class="row text-center" id="shoes" >
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                    <a class="text-dark" href="9.php">  <img src="images/shoe1.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h6>Nike White Sneaker</h6></a>
                            <h6>Price :₱ 8000</h6>
                            <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                    <a class="text-dark" href="10.php">  <img src="images/shoe2.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h6>Nike White Shoes</h6></a>
                            <h6>Price :₱ 7500</h6>
                            <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                    <a class="text-dark" href="11.php"> <img src="images/shoe3.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h6>Nike Yellow Sneaker</h6></a>
                            <h6>Price :₱ 7000</h6>
                            <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                ...
                <div class="col-md-3 col-6 py-3" >
                    <div class="card">
                    <a class="text-dark" href="12.php"> <img src="images/shoe4.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                        <h6>Nike Sneaker</h6></a>
                    <h6>Price :₱ 6000</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
            ...
            <div class="row text-center" id="headphones">
                    <div class="col-md-3 col-6 py-3" >
                        <div class="card">
                        <a class="text-dark" href="13.php">  <img src="images/sp1.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Beats Headphone</h6></a>
                                <h6>Price :₱ 22,500</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                        <a class="text-dark" href="14.php"> <img src="images/sp2.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Zolo Headphone</h6></a>
                                <h6>Price :₱ 4500</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                        <a class="text-dark" href="15.php"><img src="images/sp3.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Sony Speaker</h6></a>
                                <h6>Price :₱ 10,500</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                   ...
                   <?php
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                        <a class="text-dark" href="16.php"> <img src="images/sp4.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Airpods</h6></a>
                                <h6>Price :₱ 15,000</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
